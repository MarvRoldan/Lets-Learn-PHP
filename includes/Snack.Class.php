...
class Snack {
    ...
    {
        $output = '';
        ob_start(); // Begins an output buffer. Holds before it sends. 
        // This closes the tag from line 1?>
            <dl>
                <dt>Name</dt>
        ...
        $output = ob_get_clean(); // We now have the buffered (echo'd) string contents save in a variable.
        if ( $echo === TRUE ) echo $output; //Output,
        return $output;
    }
}